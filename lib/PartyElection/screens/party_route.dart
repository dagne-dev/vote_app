...
class PartyAppRoute {
  static Route generateRoute(RouteSettings settings) {
    ...
    if (settings.name == PartyList.routeName) {
    ...
    if (settings.name == PartyVoteProgress.routeName) {
      Party party = settings.arguments;
      return MaterialPageRoute(
          builder: (context) => PartyVoteProgress(
                party: party,
              ));
    }
    ...
    if (settings.name == AccountInformation.routeName) {
      Election election = settings.arguments;
      return MaterialPageRoute(builder: (context) => AccountInformation());
    }
